...
if __name__ == '__main__':
    ...
    # Model Parameters
    parser.add_argument('--lr', type=float, default=0.01, metavar='LR', help='learning rate for optimizer')
    parser.add_argument('--input_dim', type=int, default=3, metavar='ID', help='input dimension for neural network')
